  ...
  if (!song) {
    return (
      <figure className="flex h-full flex-col gap-2.5">
        <div className="flex aspect-[2.4/1] flex-col overflow-hidden rounded-[10px] border border-hair bg-bg-panel">
  ...
  return (
    <figure className="flex flex-col gap-2.5">
      <a
        ...
        className="group flex aspect-[2.4/1] flex-col overflow-hidden rounded-[10px] border border-hair bg-bg-panel transition-colors hover:border-[var(--accent)]"
